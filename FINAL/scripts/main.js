...
function initializeArray()
{
  ...
  var myAdventure3 = new adventureScreen("images/blank.jpg", "This can't be good. I'll take this tracking device with me to pin down where it came from. Let's hope for the best...");
  var myAdventure4 = new adventureScreen("images/blank.jpg", "You come upon a cave. There appears to have once been a locked door over its entrance that has been broken. Only one way to figure out what's inside...");
  ...
  var myAdventure6 = new adventureScreen("images/blank.jpg", "A TERRITORIAL MECHA-MOTH! Think fast!");
  var myAdventure7 = new adventureScreen("images/blank.jpg", "You have successfully battled and defeated the Mecha-Moth. You choose to assimilate its antennae into your arm to aid in your navigation. The antennae appear to have a sonar function, allowing you to find your way through the dark easier.");
  var myAdventure8 = new adventureScreen("images/blank.jpg", "The sonar capabilities of the Mechantennae have revealed a new path to you in the cave. You take it to see where it leads.");
